...
public class Plateau {
	...
	private void creerCase() {
	    ...
	    CasePropriete bleuClair3 = new Terrain("Avenue de la r�publique", 2, 4, new double[] {2, 4, 6, 8, 10, 15});
	    ...
	    CasePropriete jaune1 = new Terrain("Faubourg Saint-Honor�", 2, 4, new double[] {2, 4, 6, 8, 10, 15});
	    ...
	    CasePropriete bleuFonce1 = new Terrain("Avenue des Champs-�lys�es", 2, 4, new double[] {2, 4, 6, 8, 10, 15});
	    CasePropriete bleuFonce2 = new Terrain("Rue de la paix", 2, 4, new double[] {2, 4, 6, 8, 10, 15});

	    
	    // Ajout des propri�t�s sous liste pour les quartiers
	    ...
	    CaseFixe taxe1 = new CaseFixe("Imp�ts sur le revenu", 200,1);
	    ...
	    Service energie1 = new Service("Compagnie de distribution d'�lectricit�");
	    ...
	    Quartier bleuFonce = new Quartier("Bleu Fonc�", LbleuF);
